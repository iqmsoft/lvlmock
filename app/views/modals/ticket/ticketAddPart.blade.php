@section('ticketAddPartModal')
<!-- Modal -->
<div class="modal fade" id="ticketAddPart" tabindex="-1" role="dialog" aria-labelledby="ticketAddPartLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="ticketAddPartLabel">Insert A Writeup</h4>
            </div>
